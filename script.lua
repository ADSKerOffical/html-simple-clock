...
local Window =
    OrionLib:MakeWindow(
    {
        Name = "Budgie Hub | Sukuma Battlegrounds",
        HidePremium = true,
        IntroEnabled = false,
        SaveConfig = false,
        ...
        Callback = function(Value)
            ...
            while SCT do
                ...
                if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Car Throw") then
                    game:GetService("Players").LocalPlayer.Character:FindFirstChild("Car Throw"):FindFirstChild(
                        "Car Throw"
                    ).Throw:FireServer()
                end
            end
...
Tab:AddButton(
    {
        ...
        Callback = function()
            ...
            game:GetService("Players").LocalPlayer.Backpack["Ember Insects"]["Ember Insects"].RemoteEvent:FireServer(
                ohCFrame1,
                ohNumber2
            )
        end
...
Tab:AddButton(
    {
        ...
        Callback = function()
            ...
            for i = 1, 10 do
                ...
                game:GetService("Players").LocalPlayer.Backpack["Pyroburst Rain"]["Pyroburst Rain"].Event:FireServer(
                    ohCFrame1
                )
            end
        end
...
Tab:AddButton(
    {
        ...
        Callback = function()
            for i = 1, 10 do
                game:GetService("Players").LocalPlayer.Backpack["Unlimited Punches"]["Unlimited Hands"].Event:FireServer(
...
Tab:AddButton(
    {
        ...
        Callback = function()
            for i = 1, 10 do
                game:GetService("Players").LocalPlayer.Backpack["Divine Dogs"].LocalScript.RemoteEvent:FireServer()
            end
        end
    }
)
...
Tab:AddButton(
    {
        ...
        Callback = function()
            for i = 1, 15 do
                game:GetService("Players").LocalPlayer.Backpack.Nue.LocalScript.RemoteEvent:FireServer()
            end
        end
    }
)
        ...
        Callback = function()
            repeat
                ...
                if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dishonored Shikigami") then
                    ...
                    game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dishonored Shikigami").FireServer.RemoteEvent:FireServer(
                        unpack(args)
                    )
                end
        ...
        Callback = function()
            ...
            for _, player in ipairs(players) do
                if player.Character then
                    ...
                    game:GetService("Players").LocalPlayer.Backpack["Dishonored Shikigami"].FireServer.RemoteEvent:FireServer(
                        ohCFrame1,
                        ohNumber2
                    )
                end
...
Tab:AddButton(
    {
        ...
        Callback = function()
            ...
            for _, player in ipairs(players) do
                if
                    player.Character and player.Character ~= game.Players.LocalPlayer.Character and
...
Tab:AddButton(
    {
        ...
        Callback = function()
            ...
            game:GetService("ReplicatedStorage")["Final Hollow Purple Assets"].Events.Abilitys.Gojo:FireServer(
                ohString1
            )
        end
    }
...
Tab:AddButton(
    {
        ...
        Callback = function()
            for i = 1, 15 do
                game:GetService("Players").LocalPlayer.Backpack["Maximum Reversal Red (Use Twice)"][
                    "Maximum Reversal Red"
                ].Event:FireServer()
            end
        end
    }
...
Tab:AddDropdown(
    {
        ...
        Callback = function(Value)
            if Value == "Summon BlackHole" then
                ...
                game:GetService("ReplicatedStorage"):WaitForChild("Yuki's Black Hole Assets"):WaitForChild("SendServer"):InvokeServer(
                    unpack(args)
                )
            end
            if Value == "Summon Box Jail" then
                ...
                for _, player in ipairs(players) do
                    if player.Character then
                        ...
                        game:GetService("ReplicatedStorage"):WaitForChild("PrisonRealmAssets"):WaitForChild("Server"):InvokeServer(
                            unpack(args)
                        )
                    end
                end
                ...
                local args = {
                    ...
                    [3] = {
                        ...
                        ["rootcf"] = CFrame.new(
                            ...
                            2.906960964202881,
                            0.999436616897583,
                            7.712181115948624e-08,
                            0.033562321215867996,
                            -7.77368711624149e-08,
                            1,
                            1.7021072551415273e-08,
                            -0.033562321215867996,
                            -1.9620513214135826e-08,
                            0.999436616897583
                        )
                    }
                }
            ...
            if Value == "Judge" then
                ...
                game:GetService("ReplicatedStorage"):WaitForChild("Divine Judgement Assets"):WaitForChild("SendServer"):InvokeServer(
                    unpack(args)
                )
            end
...
Tab:AddButton(
    {
        ...
        Callback = function()
            loadstring(
                game:HttpGet("https://raw.githubusercontent.com/ADSKerOffical/NonAdminCmds/main/SukunaBattlegrounds")
            )()
        end
    }
)
...
Tab:AddButton(
    {
        ...
        Callback = function()
            if
                game.Players.LocalPlayer.UserId == 4636825706 or game.Players.LocalPlayer.UserId == 5042713445 or
                    game.Players.LocalPlayer.UserId == 6036506267 or
                    game.Players.LocalPlayer.UserId == 6103186375 or
                    game.Players.LocalPlayer.UserId == 1156091597 or
                    game.Players.LocalPlayer.UserId == 2822056554
             then
                loadstring(
                    game:HttpGet("https://raw.githubusercontent.com/ADSKerOffical/AdminCmds/main/SukunaBattlegrounds")
                )()
            else
                OrionLib:MakeNotification(
                    {
...
Tab:AddToggle(
    {
        ...
        Callback = function(Value)
            ...
            while SA do
                ...
                game:GetService("ReplicatedStorage"):WaitForChild("Serious Sneeze Assets"):WaitForChild("SendServer"):InvokeServer(
                    unpack(args)
                )
            end
        end
            ...
            local function ActTwo()
                ...
                if targetPlayer then
                    ...
                    for i, v in pairs(speaker.Character:GetDescendants()) do
                        if
                            v:IsA("BodyVelocity") or v:IsA("BodyGyro") or v:IsA("RocketPropulsion") or
                                v:IsA("BodyThrust") or
...
Tab:AddToggle(
    {
        ...
        Callback = function(Value)
            ...
            while RPA do
                wait(0.5)
                local parts =
                    workspace:GetPartBoundsInRadius(player.Character:WaitForChild("HumanoidRootPart").Position, 7)
                local foundEntity = false
                for _, part in ipairs(parts) do
                    if
                        (part:IsA("BasePart") or part:IsA("UnionOperation") or part:IsA("Model")) and not part.Anchored and
                            part:IsDescendantOf(workspace) and
                            not part:IsDescendantOf(player.Character)
                     then
                        foundEntity = true
                        break
                    end
        ...
        Callback = function(Value)
            ...
            while DD do
                ...
                if game.Players.LocalPlayer.Character.Humanoid.Health <= 0 then
                    ...
                    game:GetService("ReplicatedStorage"):WaitForChild("Yuki's Black Hole Assets"):WaitForChild(
                        "SendServer"
...
Tab:AddButton(
    {
        ...
        Callback = function()
            loadstring(
                game:HttpGet("https://raw.githubusercontent.com/ADSKerOffical/SukunaBattlegrounds_Flash/main/Character")
            )()
        end
    }
)
